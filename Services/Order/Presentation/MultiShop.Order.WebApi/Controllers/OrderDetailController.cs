...
namespace MultiShop.Order.WebApi.Controllers
{
    ...
    public class OrderDetailController : ControllerBase
    {
        ...
        public OrderDetailController(UpdateOrderDetailCommandHandler updateOrderDetailCommandHandler,CreateOrderDetailCommandHandler createOrderDetailCommandHandler,GetOrderDetailQueryHandler getOrderDetailQueryHandler,GetOrderDetailQueryByIdHandler getOrderDetailQueryByIdHandler,RemoveOrderDetailCommandHandler removeOrderDetailCommandHandler)
        {
