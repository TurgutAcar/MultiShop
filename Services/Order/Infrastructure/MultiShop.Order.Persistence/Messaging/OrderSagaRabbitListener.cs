...
{
    public class OrderSagaRabbitListener : BackgroundService
    {
        private readonly IServiceProvider _serviceProvider;
        private IConnection _connection;
        private IModel _channel;

        public OrderSagaRabbitListener(IServiceProvider serviceProvider)
        {
            ...
            switch (eventType)
            {
                case "StockReservedEvent":
                    ...
                    var reservedConsumer = scope.ServiceProvider
                        .GetRequiredService<StockReservedEventConsumer>();
